...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_404_sent_requesting_non_existing_category(self):
        res = self.client().get('/api/v1/categories/9999')
        data = json.loads(res.data)
    ...
    def test_delete_question(self):
        ...
        res = self.client().delete('/api/v1/questions/{question_id}')
        data = json.loads(res.data)
    ...
    def test_422_sent_deleting_non_existing_question(self):
        res = self.client().delete('/api/v1/questions/a')
        data = json.loads(res.data)
    ...
    def test_add_question(self):
        ...
        res = self.client().post('/api/v1/questions', json=new_question)
        data = json.loads(res.data)
    ...
    def test_search_questions(self):
        ...
        res = self.client().post('/api/v1/questions/search', json=new_search)
        data = json.loads(res.data)
    ...
    def test_404_get_questions_per_category(self):
        res = self.client().get('/api/v1/categories/a/questions')
        data = json.loads(res.data)
    ...
    def test_play_quiz(self):
        ...
        res = self.client().post('/api/v1/quizzes', json=new_quiz_round)
        data = json.loads(res.data)
